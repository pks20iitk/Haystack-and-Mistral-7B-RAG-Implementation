from haystack.nodes import EmbeddingRetriever, MarkdownConverter, PreProcessor, AnswerParser, PromptModel, PromptNode, \
    PromptTemplate
...
OPENAI_API_KEY = os.getenv("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")
